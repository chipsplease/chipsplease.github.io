...
function populate_playlists(playlists){
    ...
    playlists.forEach(playlist => {
        ...
        playlist_title_container = document.createElement('div');
        playlist_title_container.className = "playlist_title_container";
        playlist_title = document.createElement('h2');
        ...
        playlist_image_container = document.createElement('div');
        ...
        playlist_description_container = document.createElement('div');
        playlist_description_container.className = "playlist_description_container";
        playlist_description = document.createElement('h2')
